...
const returns = {
  ...
  set_build_component: 'Returns the changed slot, selected part, selected price, remaining budget, selected count, completeness and compatibility. Selecting a case also returns its bundled fan id. The command preserves the shopper\'s current storefront page.',
  ...
  inspect_build_options: 'Returns the current brief, budget, selected price, build revision, and one to four requested candidates with listing data, specs, normalized facts and current fit issues. It records the inspection in UI state but does not navigate or select a candidate.',
